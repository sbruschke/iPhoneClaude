...
// ClaudeFileServer vendoring note: ZIPFoundation's zlib branch is disabled
// so the project doesn't need libz.tbd linkage. The builtInCRC32 fallback
// in this file is pure Swift and correct; the only cost is a modest CRC
// throughput hit, which is irrelevant at our file sizes.
// #if canImport(zlib)
// import zlib
// #endif
...
extension Data {
    ...
    public func crc32(checksum: CRC32) -> CRC32 {
        // See vendoring note at top of file — forced to builtInCRC32 to avoid
        // libz linkage.
